...
_GKunit setSkill ["endurance", 0.50];
_GKunit setSkill ["spotDistance", 0.01];
_GKunit setSkill ["spotTime", 0.01];
_GKunit setSkill ["courage", 0.50];
_GKunit setSkill ["reloadSpeed", 0.50];
_GKunit setSkill ["commanding", 0.50];
_GKunit setSkill ["general", 0.50];
